    ...
    <html lang="pt-BR" className={`${poppins.variable}`}>
      <StyledComponentsRegistry>
        <ConfigProvider theme={theme}>
          <HeaderNavigator />
          <body className="mx-auto my-0 mb-8 flex min-h-screen flex-col items-center bg-gray-100 sm:w-[640px] md:w-[768px] lg:w-[1024px] xl:w-[1280px] 2xl:w-[1536px]">
            <Toaster />
            <div className="w-full max-w-full py-2 max-lg:px-2">{children}</div>
          </body>
